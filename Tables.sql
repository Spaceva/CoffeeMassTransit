...
CREATE TABLE [dbo].[CoffeeOrderStates](
 ...
 CONSTRAINT [PK_CoffeeOrderStates] PRIMARY KEY CLUSTERED 
(
	[CorrelationId] ASC
...
CREATE TABLE [dbo].[CoffeeMachineStates](
	[CorrelationId] [uniqueidentifier] NOT NULL,
	[OrderId] [uniqueidentifier] NOT NULL,
	[CurrentState] [nvarchar](50) NOT NULL,
	[ToppingsRequested] [nvarchar](50) NULL,
	[CoffeeTypeRequested] [int] NOT NULL,
 CONSTRAINT [PK_CoffeeMachineStates] PRIMARY KEY CLUSTERED 
(
	[CorrelationId] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
